...
CREATE PROCEDURE [dbo].[sp_crm_customersurvey_sales] 
(  
@process_key					int
) AS
...
-- 06 Jan 2012 - Swanson Phung: fine-tuned
...
SET 	@JobDesc		= 'CRM Customer Survey Sales'
SET		@CampaignType	= 'CustomerSurvey - Sales'
